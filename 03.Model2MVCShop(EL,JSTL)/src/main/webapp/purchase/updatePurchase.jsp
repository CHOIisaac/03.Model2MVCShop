...
<%-- 		<td class="ct_write01"><%=vo.getBuyer().getUserId()%></td> --%>
		...
		<input type="hidden" name="buyerId" value="${vo.buyer.userId}" />
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
...
<%-- 			<input type="text" readonly="readonly" name="divyDate" class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="20" value="<%=vo.getDivyDate()%>"/>
 --%>
 				<input type="text" readonly="readonly" name="divyDate" class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="20" value="${vo.divyDate}"/>
